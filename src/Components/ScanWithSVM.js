...
class ScanWithSVM extends React.Component{
    constructor(props) {
        super(props);
    ...
    handleUploadFile(ev) {
        ...
        fetch('http://localhost:5000/ScanWithSVM', {
            method: 'POST',
            body: data,
        })
            ...
            <div>
                ...
                <div class="scan-page">
                    <div class="model-title-container">
                        <h1 class="model-title">Scan with Support Vector Machine</h1>
                        <p class="model-desc">Support Vector Machine is a high perform algorithm for classification</p>
                        {/* <p class="model-desc">Support Vector Machine is a powerful supervised learning algorithm used for classification</p> */}
                    ...
                    <div class="others-ml">
                        ...
                        <a href='/ScanWithKNN'>
                            <button class="another-ml">SCAN WITH KNN</button>
                        </a>
