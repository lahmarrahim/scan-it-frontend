...
class ScanWithRF extends React.Component{
    constructor(props) {
        super(props);
    ...
    handleUploadFile(ev) {
        ...
        fetch('http://localhost:5000/ScanWithRF', {
            method: 'POST',
            body: data,
        })
            ...
            <div>
                ...
                <div class="scan-page">
                    <div class="model-title-container">
                        <h1 class="model-title">Scan with Random Forest</h1>
                        <p class="model-desc">Random Forest is a high perform algorithm for classification</p>
