...
class ScanWithLR extends React.Component{
    constructor(props) {
        super(props);
    ...
    handleUploadFile(ev) {
        ...
        fetch('http://localhost:5000/ScanWithLR', {
            method: 'POST',
            body: data,
        })
            ...
            <div>
                ...
                <div class="scan-page">
                    <div class="model-title-container">
                        <h1 class="model-title">Scan with Logistic Regression</h1>
                        <p class="model-desc">Logistic Regression is a high perform algorithm for classification</p>
                        {/* <p class="model-desc">Logistic Regression is a widely used for binary classification problems</p> */}
