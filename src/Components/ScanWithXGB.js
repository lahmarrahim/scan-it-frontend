...
class ScanWithXGB extends React.Component{
    constructor(props) {
        super(props);
    ...
    handleUploadFile(ev) {
        ...
        fetch('http://localhost:5000/ScanWithXGB', {
            method: 'POST',
            body: data,
        })
            ...
            <div>
                ...
                <div class="scan-page">
                    <div class="model-title-container">
                        <h1 class="model-title">Scan with XGBoost</h1>
                        <p class="model-desc">XGBoost is a high perform algorithm for classification</p>
